            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href = "/tarefausuario/{{$tarefa->projeto->id}}/{{$tarefa->id}}" class = "btn btn-sm btn-primary"> Alocar usuário </a>
                        <a href = "/gerenciarTarefa/{{$tarefa->id}}" class = "btn btn-sm btn-primary"> <svg width="1.5em" height="1.5em" viewBox="0 0 16 16" class="bi bi-pencil-square" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
