      ...
      <div class="wrapper ">
        ...
        -->
          ...
          <div class="sidebar-wrapper">
            <ul class="nav">
                <li @if($current=="perfil") class="nav-item active" @else class="nav-item" @endif>
                    <a class="nav-link" href="/meuperfil/editar">
                ...
                <ul class="navbar-nav">
                  ...
                  <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownProfile">
                      <a class="dropdown-item" href="/meuperfil/editar">Editar perfil</a>
                      <div class="dropdown-divider"></div>
